...
// ISVAddonReconciler reconciles a ISVAddon object
type ISVAddonReconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

// +kubebuilder:rbac:groups=example.com.example.com,resources=isvaddons,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=example.com.example.com,resources=isvaddons/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=example.com.example.com,resources=isvaddons/finalizers,verbs=update
// +kubebuilder:rbac:groups=example.com.example.com,resources=isventerprises,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=example.com.example.com,resources=isventerprises/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=example.com.example.com,resources=isventerprises/finalizers,verbs=update
// +kubebuilder:rbac:groups=core,resources=secrets,verbs=get;list;watch;create;update;patch
func (r *ISVAddonReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	logger := log.FromContext(ctx)

	// fetch subject addon
	addon := &v1alpha1.ISVAddon{}
	...
	finalizerName := isv.CommonISVInstance.GetISVPrefix() + "addons.example.com/finalizer"
...
func (r *ISVAddonReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&v1alpha1.ISVAddon{}).
		//Owns(&configv1.ClusterVersion{}).
		Complete(r)
}

// builds enterprise resource from file setting the addon as the owner
func (r *ISVAddonReconciler) buildEnterpriseResource(ctx context.Context, addon *v1alpha1.ISVAddon, namespace string, manifest []byte) (unstructured.Unstructured, error) {
...
func (r *ISVAddonReconciler) DeployEnterpriseServiceMonitor(serviceMonitorName string, serviceMonitorNamespace string, enterprise map[string]string) *promv1.ServiceMonitor {
...
func (r *ISVAddonReconciler) DeployPrometheusRules(prometheusRuleName string, prometheusRuleNamespace string, rules []byte) (*promv1.PrometheusRule, error) {
...
func (r *ISVAddonReconciler) DeployFederationServiceMonitor(fedServiceMonitorName string, fedServiceMonitorNamespace string, metrics string) *promv1.ServiceMonitor {
...
func (r *ISVAddonReconciler) DeployPrometheus(vaultSecretName string, tokenURL, remoteWriteURL, regex, clusterID, prometheusName, namespace string) *promv1.Prometheus {
